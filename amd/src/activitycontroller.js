/* jshint ignore:start */
define(['jquery','jqueryui', 'core/log','mod_NEWMODULE/recorderhelper'], function($, jqui, log, recorderhelper) {
    ...
    return {
        ...
        send_submission: function(filename){
            ...
            xhr.open("POST",M.cfg.wwwroot + '/mod/NEWMODULE/ajaxhelper.php', true);
        ...
        douploadlayout: function(){
            var m = this;
            m.controls.passagecontainer.addClass('mod_NEWMODULE_passage_finished');
