define(['jquery','core/log'], function($,log) {
    ...
    log.debug('NEWMODULE grading helper: initialising');

    return {

        controls: {},
        hiddenplayer: 'mod_NEWMODULE_hidden_player',
        hiddenplayerbutton: 'mod_NEWMODULE_hidden_player_button',
        activebutton: 'mod_NEWMODULE_hidden_player_button_active',
        activebuttonpaused: 'mod_NEWMODULE_hidden_player_button_paused',
        activebuttonplaying: 'mod_NEWMODULE_hidden_player_button_playing',
        ...
        dohiddenplay: function (audiosrc) {
            var m = this;//M.mod_NEWMODULE.gradinghelper;
