...
class restore_NEWMODULE_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('READALOUDVIEWBYID', '/mod/NEWMODULE/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('READALOUDINDEX', '/mod/NEWMODULE/index.php?id=$1', 'course');
